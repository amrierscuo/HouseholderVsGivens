...
% Init
sizes = 2:2:6;  % Dimensioni delle matrici
nSizes = length(sizes);
...
% Crea un grafico per il numero di condizionamento
figure;
plot(sizes, condNum, 'r', 'LineWidth', 2);
xlabel('Dimensione della matrice');
ylabel('Numero di condizionamento');
title('Numero di condizionamento Householder e Givens');
grid on;
